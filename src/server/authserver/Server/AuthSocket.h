...
private:
	...
	// Since GetLocalByName() is _NOT_ bijective, we have to sore the locale as a string.
	// Otherwise we can't differ between enUS and enGB, wich is important for the patch system.
